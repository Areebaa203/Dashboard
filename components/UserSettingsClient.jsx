  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-zinc-500 mb-6">Manage your personal account preferences.</p>
      ...
      <div className="grid grid-cols-1 gap-8">
          ...
          <div className="p-6 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                <label className="text-sm font-semibold px-1">Display Name</label>
                <input 
                  type="text" 
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  disabled
                  className="w-full bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl px-4 py-2.5 text-sm outline-none opacity-60 cursor-not-allowed"
                />
              </div>
            </div>
          </div>
        ...
        <section className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            {[
              { title: "Order Updates", desc: "Get notified when your order status changes.", icon: Mail, enabled: true },
              { title: "Personal Offers", desc: "Receive customized discounts and deals.", icon: Shield, enabled: false },
            ].map((item, idx) => (
              <div key={idx} className="flex items-center justify-between py-2">
                ...
                <div className={`w-12 h-6 rounded-full p-1 transition-colors ${item.enabled ? 'bg-blue-500' : 'bg-zinc-200 dark:bg-zinc-800'}`}>
        ...
        <div className="flex justify-end">
          <button 
            onClick={handleSave}
            disabled={isSaving}
            className="text-sm font-semibold py-2.5 px-8 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-all disabled:opacity-50"
          >
