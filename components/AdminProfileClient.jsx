...
export function AdminProfileClient() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">System Admin Profile</h1>
        <p className="text-zinc-500 mt-2">Manage infrastructure permissions and security settings.</p>
      </div>

      <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
        <div className="h-32 bg-indigo-500" />
        <div className="px-8 pb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-1">
              <label className="text-xs font-bold uppercase tracking-widest text-zinc-400">System Identity</label>
            ...
            <div className="space-y-1">
              <label className="text-xs font-bold uppercase tracking-widest text-zinc-400">Security Access</label>
              <div className="flex items-center gap-3 p-3 bg-zinc-50 dark:bg-zinc-950 rounded-xl border border-zinc-100 dark:border-zinc-800">
                <Lock size={18} className="text-zinc-400" />
                <span className="text-sm font-medium">Full Access (Tier 1)</span>
              </div>
            </div>
