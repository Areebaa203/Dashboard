                ...
                <tr key={product.id} className="border-b border-zinc-50 dark:border-zinc-900/50 hover:bg-zinc-50/80 dark:hover:bg-zinc-900/30 transition-colors group">
                  ...
                  <td className="px-6 py-5">
                    <span className={cn(
                      ...
                      {product.compliance === "Approved" ? <CheckCircle size={10} /> : <AlertTriangle size={10} />}
                      {product.compliance}
                    </span>
                  </td>
                  <td className="px-8 py-5 text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button className="p-2.5 hover:bg-zinc-100 dark:hover:bg-zinc-900 rounded-xl transition-all">
